...
const SectionTitle = styled.h3`
  ${tw`text-gray-500 text-sm uppercase`}
`;
...
const Input = styled.input.attrs({
  ...
  ${tw`border border-transparent shadow focus:shadow-lg focus:bg-gray-100 focus:text-gray-500 text-white rounded bg-gray-800 py-2 pr-4 pl-10 block max-w-xl appearance-none leading-normal w-full mb-12 mx-auto`}
  transition: all .2s;
  &:focus {
    outline: 0;
  }
